...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/open-source-integration-2",
  },
  openGraph: {
    ...
    url: "https://viobts.com/open-source-integration-2",
    type: "website",
    images: [
      {
...
export default function OpenSourceIntegrationTwoPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "Service",
        "@id": "https://viobts.com/open-source-integration-2#service",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://viobts.com/open-source-integration-2#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "item": "https://viobts.com/open-source-integration-2"
          }
        ]
      }
    ]
