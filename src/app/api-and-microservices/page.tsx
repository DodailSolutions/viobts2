...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/api-and-microservices",
  },
  openGraph: {
    ...
    url: "https://viobts.com/api-and-microservices",
    type: "website",
    images: [
      {
...
export default function ApiAndMicroservicesPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "Service",
        "@id": "https://viobts.com/api-and-microservices#service",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://viobts.com/api-and-microservices#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "item": "https://viobts.com/api-and-microservices"
          }
        ]
      }
    ]
