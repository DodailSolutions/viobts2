...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://viobts.com/rpa-ml-ai-2",
    type: "website",
    images: [
      {
...
export default function RpaMlAiTwoPage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "Service",
        "@id": "https://viobts.com/rpa-ml-ai-2#service",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://viobts.com/rpa-ml-ai-2#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "RPA, ML & AI",
            "item": "https://viobts.com/rpa-ml-ai-2"
          }
        ]
      }
    ]
