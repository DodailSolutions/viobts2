...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/big-data-and-analytics-3",
  },
  openGraph: {
    ...
    url: "https://viobts.com/big-data-and-analytics-3",
    type: "website",
    images: [
      {
...
export default function BigDataAnalyticsThreePage() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "Service",
        "@id": "https://viobts.com/big-data-and-analytics-3#service",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://viobts.com/big-data-and-analytics-3#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "item": "https://viobts.com/big-data-and-analytics-3"
          }
        ]
      }
    ]
