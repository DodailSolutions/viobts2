...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://viobts.com/cloud-enablement",
    type: "website",
    images: [
      {
...
export default function CloudEnablementPage() {
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "Service",
        "@id": "https://viobts.com/cloud-enablement#service",
      ...
      {
        "@type": "BreadcrumbList",
        "@id": "https://viobts.com/cloud-enablement#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "position": 3,
            "name": "Cloud Enablement & CI/CD Pipelines",
            "item": "https://viobts.com/cloud-enablement"
          }
        ]
      }
    ]
